...
Use this list when a profile or icon set needs colors from the fixed 2014 Material Design palette. Material Design 3 uses generated tonal palettes and semantic color roles instead of this fixed list.

The `500` shade is the main shade of each hue. The `50` shade is the lightest standard shade. The `900` shade is the darkest standard shade. Most chromatic hues also have the accent shades `A100`, `A200`, `A400`, and `A700`.
...
`Gray` and `Blue Gray` are also written as `Grey` and `Blue Grey` in some libraries.

## Accent shades

| Hue | A100 | A200 | A400 | A700 |
| --- | --- | --- | --- | --- |
...
Brown, Gray, and Blue Gray do not have standard accent shades.
...
- [Material Design 2 color system](https://m2.material.io/guidelines/style/color.html)
- [Material UI 2014 color palettes](https://mui.com/material-ui/customization/color/)
- [Material UI color reference](https://materialui.co/colors)
- [Material Palette color reference](https://www.materialpalette.com/colors)
